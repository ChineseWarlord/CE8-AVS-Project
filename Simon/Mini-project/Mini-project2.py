...
def runDaskMandelbrotCluster(chunks: List[int],IP:str, workers:int, process:bool) -> Tuple[np.ndarray, list]:
...
if __name__ == "__main__":
    ...
    img_mandel, times = runDaskMandelbrotCluster(chunks, "10.92.0.71:8786", 8, True)
